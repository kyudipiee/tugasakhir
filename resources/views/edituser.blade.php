                            ...
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <form action="/updatedatauser/{{ $data->id }}" method="post" class="user">
                                        ...
                                        <div class="form-group">
                                                <label class="form-label text-white" for="form3Examplev4">Role</label>
                                                <select class="form-control form-control" name="role" id="defaultSelect" aria-label="Default select example">
